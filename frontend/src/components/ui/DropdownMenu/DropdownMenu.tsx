...
export const DropdownMenuPortal: FC<ComponentProps<typeof DropdownMenuPrimitive.Portal>> = (
  props,
) => <DropdownMenuPrimitive.Portal data-slot="dropdown-menu-portal" {...props} />;

export const DropdownMenuTrigger: FC<ComponentProps<typeof DropdownMenuPrimitive.Trigger>> = (
  props,
...
export const DropdownMenuGroup: FC<ComponentProps<typeof DropdownMenuPrimitive.Group>> = (
  props,
...
export const DropdownMenuRadioGroup: FC<ComponentProps<typeof DropdownMenuPrimitive.RadioGroup>> = (
  props,
